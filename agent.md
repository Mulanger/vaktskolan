...
Status 2026-07-07: `auth.js` har robustare mount-logik för Clerk-formuläret. Sign in/sign up monteras i en separat `data-auth-clerk-root`, mounten kontrolleras efter render, och sidan försöker montera om formuläret om containern blir tom vid hash-/historiknavigering eller fokusbyte. `login.html` cache-bustar detta med `auth.js?v=20260707-robust-clerk-mount` och `auth.css?v=20260707-robust-clerk-mount`.
